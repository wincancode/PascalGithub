...
begin
  ...
  clrscr;
  Writeln('Por favor ingrese el sueldo basico mensual del trabajador en bolivares.');
  Readln(sueldo_basico_mensual);

  clrscr;
  Writeln('Por favor ingrese la prima de transporte en bolivares.');
  Readln(prima_de_transporte);

  clrscr;
  Writeln('Por favor ingrese el bono de alimentacion en bolivares.');
